package com.training.jhipster.store.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("AppStore");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("AppStore");
        ...
        config.getMapConfigs().put("com.training.jhipster.store.domain.*", initializeDomainMapConfig(jHipsterProperties));

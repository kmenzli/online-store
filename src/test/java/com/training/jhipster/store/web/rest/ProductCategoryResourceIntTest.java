...
import com.training.jhipster.store.domain.ProductCategory;
import com.training.jhipster.store.repository.ProductCategoryRepository;
import com.training.jhipster.store.service.ProductCategoryService;
...
import static com.training.jhipster.store.web.rest.TestUtil.createFormattingConversionService;
...
public class ProductCategoryResourceIntTest {
    ...
    private static final String DEFAULT_DESCRIPTINO = "AAAAAAAAAA";
    private static final String UPDATED_DESCRIPTINO = "BBBBBBBBBB";
    ...
    public static ProductCategory createEntity(EntityManager em) {
        ProductCategory productCategory = new ProductCategory()
            .name(DEFAULT_NAME)
            .descriptino(DEFAULT_DESCRIPTINO);
    ...
    public void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getDescriptino()).isEqualTo(DEFAULT_DESCRIPTINO);
    }
    ...
    public void getAllProductCategories() throws Exception {
        ...
        restProductCategoryMockMvc.perform(get("/api/product-categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].descriptino").value(hasItem(DEFAULT_DESCRIPTINO.toString())));
    }
    ...
    public void getProductCategory() throws Exception {
        ...
        restProductCategoryMockMvc.perform(get("/api/product-categories/{id}", productCategory.getId()))
            ...
            .andExpect(jsonPath("$.descriptino").value(DEFAULT_DESCRIPTINO.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateProductCategory() throws Exception {
        ...
        updatedProductCategory
            .name(UPDATED_NAME)
            .descriptino(UPDATED_DESCRIPTINO);
        ...
        assertThat(testProductCategory.getDescriptino()).isEqualTo(UPDATED_DESCRIPTINO);
    }
